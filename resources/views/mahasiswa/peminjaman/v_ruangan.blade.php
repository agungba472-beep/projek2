                ...
                <tbody>
                    ...
                    <div class="modal fade" id="modalHapus{{ $r->peminjaman_ruangan_id }}">
                        <div class="modal-dialog">
                            <form method="POST" action="{{ route('pinjam.ruangan.delete') }}">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal fade" id="modalKembali{{ $r->peminjaman_ruangan_id }}">
                        <div class="modal-dialog">
                            <form method="POST" action="/mahasiswa/peminjaman/ruangan/kembalikan/{{ $r->peminjaman_ruangan_id }}" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-content text-dark">
