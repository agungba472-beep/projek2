                ...
                <tbody>
                    ...
                    <div class="modal fade" id="modalKembali{{ $d->peminjaman_fasilitas_id }}" tabindex="-1">
                        <div class="modal-dialog">
                            <form method="POST" action="{{ route('dosen.pinjam.fasilitas.kembalikan', $d->peminjaman_fasilitas_id) }}" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="modal fade" id="modalBatalkan{{ $d->peminjaman_fasilitas_id }}" tabindex="-1">
                        <div class="modal-dialog">
                            <form method="POST" action="{{ route('dosen.pinjam.fasilitas.batalkan', $d->peminjaman_fasilitas_id) }}">
                                @csrf
                                @method('DELETE')
                                <div class="modal-content text-dark">
                                    <div class="modal-header">
...
<div class="modal fade" id="tambahModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('dosen.pinjam.fasilitas.store') }}" method="POST">
            @csrf
